...
// State untuk melacak status pengiriman form
  ...
  return (
    <div className="bg-[#0b1121] min-h-screen font-sans text-slate-300 selection:bg-emerald-500/30 selection:text-emerald-200 overflow-x-hidden">
      ...
      {/* --- NAVBAR --- */}
      <nav className="fixed top-0 w-full bg-[#0b1121]/90 backdrop-blur-md z-50 border-b border-slate-800/50">
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center relative">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold tracking-wider text-slate-100 uppercase text-sm">Zacky.Dev</span>
          </div>

          <div className="hidden md:flex gap-8 text-sm font-medium text-slate-400">
            {['Beranda', 'Keahlian', 'Pendidikan', 'Proyek', 'Pengalaman', 'Kontak'].map((item) => (
              <a key={item} href={`#${item.toLowerCase()}`} className="hover:text-emerald-400 transition-colors py-1">
                {item}
              </a>
            ))}
          </div>
          ...
          <button 
            className="md:hidden text-slate-300 hover:text-emerald-400 focus:outline-none"
          ...
          <div className={`absolute top-full left-0 w-full bg-[#0b1121]/95 border-b border-slate-800/50 flex flex-col py-4 px-6 gap-4 backdrop-blur-md md:hidden transition-all duration-300 origin-top ${isMenuOpen ? 'scale-y-100 opacity-100' : 'scale-y-0 opacity-0'}`}>
            {['Beranda', 'Keahlian', 'Pendidikan', 'Proyek', 'Pengalaman', 'Kontak'].map((item) => (
              <a 
                key={item} 
      ...
      <section id="beranda" className="pt-32 pb-16 md:pt-40 md:pb-20 px-6 max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center gap-10 md:gap-12 min-h-[90vh]">
        ...
        <div className="md:w-3/5 text-center md:text-left reveal from-left">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-slate-100 mb-4 tracking-tight">
            Zackyannafi Nashru Romadhoni
          </h1>
          <h2 className="text-xl md:text-2xl font-mono text-emerald-400 mb-4 h-8">
          ...
          <p className="text-slate-400 leading-relaxed mb-8 text-base md:text-lg text-justify md:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 font-mono text-sm justify-center md:justify-start">
            <a href="#proyek" className="bg-emerald-500 text-slate-950 px-8 py-3 rounded-lg font-bold hover:bg-emerald-400 transition-all shadow-[0_0_20px_rgba(16,185,129,0.3)] text-center hover:scale-105 transform">
              &gt; Lihat_Proyek
            </a>
            <a href="CV.pdf" target="_blank" rel="noopener noreferrer" className="bg-transparent border border-slate-700 text-slate-300 px-8 py-3 rounded-lg font-medium hover:border-emerald-500 hover:text-emerald-400 transition-all text-center hover:scale-105 transform flex items-center justify-center gap-2">
        ...
        <div className="md:w-2/5 flex justify-center mt-10 md:mt-0 reveal from-right">
          <div className="relative w-56 h-72 md:w-64 md:h-80 group">
            ...
            <div className="absolute inset-0 bg-slate-800 rounded-2xl border border-slate-700 overflow-hidden z-10">
              <img 
                ...
                onError={(e) => {
                  ...
                  e.target.src = "https://ui-avatars.com/api/?name=Zacky&background=10b981&color=0b1121&size=512";
                }}
              />
            </div>
          </div>
      ...
      {/* --- SKILLS SECTION --- */}
      <section id="keahlian" className="py-16 md:py-24 px-6 bg-[#0f172a] border-y border-slate-800/50">
        <div className="max-w-6xl mx-auto reveal">
          <h2 className="text-2xl md:text-3xl font-bold text-slate-100 mb-8 md:mb-12 flex items-center gap-4">
            <span className="text-emerald-500 font-mono text-lg md:text-xl">01.</span> Tech Stack
            <div className="h-px bg-slate-800 flex-grow ml-2 md:ml-4"></div>
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-[#0b1121] border border-slate-800 rounded-xl p-6 md:p-8 hover:border-emerald-500/50 transition-colors group">
              <div className="text-emerald-400 mb-6 font-mono text-base md:text-lg group-hover:-translate-y-1 transition-transform flex items-center gap-2">
              ...
              <div className="flex flex-wrap gap-3">
                {['React.js', 'JavaScript (ES6+)', 'HTML5', 'CSS3 / Tailwind', 'UI/UX Design', 'Responsive Web'].map(skill => (
                  <span key={skill} className="bg-emerald-500/10 text-emerald-300 border border-emerald-500/20 px-4 py-2 rounded-full text-sm font-medium hover:bg-emerald-500/20 transition-colors">
                    {skill}
                  </span>
                ))}
              </div>
            ...
            <div className="bg-[#0b1121] border border-slate-800 rounded-xl p-6 md:p-8 hover:border-cyan-500/50 transition-colors group">
              <div className="text-cyan-400 mb-6 font-mono text-base md:text-lg group-hover:-translate-y-1 transition-transform flex items-center gap-2">
              ...
              <div className="flex flex-wrap gap-3">
                {['MySQL', 'Firebase', 'Relational DB Design', 'Java', 'Python', 'RESTful API', 'Data Architecture'].map(skill => (
                  <span key={skill} className="bg-cyan-500/10 text-cyan-300 border border-cyan-500/20 px-4 py-2 rounded-full text-sm font-medium hover:bg-cyan-500/20 transition-colors">
                    {skill}
                  </span>
                ))}
              </div>
      ...
      <section id="pendidikan" className="py-16 md:py-24 px-6">
        <div className="max-w-6xl mx-auto reveal">
          ...
          <div className="bg-[#0f172a] border border-slate-700 rounded-2xl p-6 md:p-10 shadow-lg relative overflow-hidden group hover:border-emerald-500/30 transition-colors">
            ...
            <div className="flex flex-col md:flex-row justify-between md:items-center mb-6">
              <div>
                <h3 className="text-2xl font-bold text-slate-100 mb-1">Universitas Duta Bangsa Surakarta</h3>
                <p className="text-emerald-400 font-medium">S1 - Teknik Informatika</p>
              </div>
              <div className="mt-4 md:mt-0 font-mono text-slate-400 bg-slate-800/50 px-4 py-2 rounded-lg inline-block border border-slate-700">
                2023 — Sekarang
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 bg-emerald-500/10 border border-emerald-500/20 px-5 py-3 rounded-xl w-fit">
              <span className="text-2xl">🎓</span>
              <div>
                <div className="text-xs text-emerald-400 font-mono">Prestasi Akademik</div>
                <div className="text-slate-100 font-bold">IPK Kumulatif: 3.78 / 4.00</div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* --- PROYEK SECTION --- */}
      <section id="proyek" className="py-16 md:py-24 px-6 bg-[#0f172a] border-y border-slate-800/50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold text-slate-100 mb-8 md:mb-12 flex items-center gap-4 reveal">
          ...
          <div className="space-y-16 md:space-y-24">
            ...
            <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-center reveal from-left">
              ...
              <div className="w-full md:w-1/2 md:pl-8 text-center md:text-left">
                <div className="flex items-center gap-3 justify-center md:justify-start mb-2">
                  <div className="text-emerald-400 font-mono text-xs md:text-sm">Featured Project</div>
                  <span className="bg-blue-500/20 text-blue-300 text-[10px] px-2 py-1 rounded-full border border-blue-500/30">Frontend</span>
                </div>
                <h3 className="text-2xl md:text-3xl font-bold text-slate-100 mb-4 hover:text-emerald-400 transition-colors cursor-pointer">Portal Berita KalahanNews</h3>
                ...
                <div className="flex gap-4 justify-center md:justify-start">
                  <a href="https://github.com/Zackynashru/kalahannews-app.git" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-purple-400 transition-colors flex items-center gap-2" title="Source Code">
                  ...
                  <a href="#" className="text-slate-400 hover:text-cyan-400 transition-colors flex items-center gap-2" title="Live Demo">
            ...
            <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-center reveal from-left">
              ...
              <div className="w-full md:w-1/2 md:pl-8 text-center md:text-left">
                <div className="flex items-center gap-3 justify-center md:justify-start mb-2">
                  ...
                  <span className="bg-purple-500/20 text-purple-300 text-[10px] px-2 py-1 rounded-full border border-purple-500/30">Web Game</span>
                </div>
                <h3 className="text-2xl md:text-3xl font-bold text-slate-100 mb-4 hover:text-purple-400 transition-colors cursor-pointer">Classic Snake Game (Snake Eye)</h3>
                <div className="bg-[#0b1121] p-6 rounded-xl border border-slate-800 text-slate-400 text-sm leading-relaxed mb-4 shadow-xl relative z-20 text-justify md:text-left">
                ...
                <div className="flex gap-4 justify-center md:justify-start">
                  <a href="https://github.com/awanitucloud/uas_python.git" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-purple-400 transition-colors flex items-center gap-2" title="Source Code">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path fillRule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z"/></svg>
                    GitHub
                  </a>
                  <a href="#" className="text-slate-400 hover:text-cyan-400 transition-colors flex items-center gap-2" title="Live Demo">
            ...
            <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-center reveal from-left">
              ...
              <div className="w-full md:w-1/2 md:pl-8 text-center md:text-left">
                ...
                <div className="flex gap-4 justify-center md:justify-start">
                  <a href="https://github.com/Zackynashru/nexus-AI" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-purple-400 transition-colors flex items-center gap-2" title="Source Code">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path fillRule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z"/></svg>
                    GitHub
                  </a>
                  <a href="https://nexus-ai-git-main-zackynashrus-projects.vercel.app" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-cyan-400 transition-colors flex items-center gap-2" title="Live Demo">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path></svg>
                    Live Demo
                  </a>
                </div>
      ...
      <section id="pengalaman" className="py-16 md:py-24 px-6">
        <div className="max-w-6xl mx-auto reveal">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-100 flex items-center justify-center gap-4">
              <span className="text-emerald-500 font-mono text-xl">04.</span> Pengalaman
            </h2>
          </div>

          <div className="max-w-4xl mx-auto relative border-l-2 border-slate-700 ml-4 md:ml-auto">
            
            {/* Card Pengalaman 1 */}
            <div className="mb-12 relative pl-8 md:pl-12">
              <div className="absolute -left-[9px] top-6 w-4 h-4 rounded-full bg-[#0b1121] border-2 border-emerald-500 shadow-[0_0_10px_rgba(16,185,129,0.5)]"></div>
              
              <div className="bg-[#0f172a] border border-slate-700 rounded-2xl p-6 md:p-8 shadow-lg hover:border-emerald-500/30 transition-colors">
                <span className="text-emerald-400 font-mono text-xs md:text-sm font-bold mb-2 block">2024 - Sekarang</span>
                <h3 className="text-xl md:text-2xl font-bold text-slate-100 mb-2">Freelance Web Developer & DB Designer</h3>
                <p className="text-slate-400 text-sm mb-6">Proyek Mandiri / Lokal</p>
                
                <ul className="text-slate-400 text-sm md:text-base space-y-4 list-disc pl-5 marker:text-emerald-500 text-justify md:text-left leading-relaxed">
                  <li><strong className="text-slate-200">Frontend UI/UX:</strong> Merancang dan membangun antarmuka web yang responsif dengan React.js untuk berbagai kebutuhan klien lokal.</li>
                  <li><strong className="text-slate-200">Arsitektur Database:</strong> Mengembangkan arsitektur database MySQL untuk aplikasi inventaris UMKM guna memastikan integritas data.</li>
                  <li><strong className="text-slate-200">Optimasi Kueri:</strong> Melakukan optimasi kueri database (SQL indexing & join optimization) untuk mempercepat waktu pemuatan (load) data hingga 30%.</li>
                </ul>
              </div>
            </div>
            ...
            <div className="relative pl-8 md:pl-12">
              <div className="absolute -left-[9px] top-6 w-4 h-4 rounded-full bg-[#0b1121] border-2 border-slate-500"></div>
              
              <div className="bg-[#0f172a] border border-slate-700 rounded-2xl p-6 md:p-8 shadow-lg hover:border-slate-500/50 transition-colors">
                <span className="text-slate-400 font-mono text-xs md:text-sm font-bold mb-2 block">2023 - 2024</span>
                <h3 className="text-xl md:text-2xl font-bold text-slate-100 mb-2">Asisten Praktikum (Data Structure)</h3>
                <p className="text-slate-400 text-sm mb-6">Universitas Duta Bangsa</p>
                
                <ul className="text-slate-400 text-sm md:text-base space-y-4 list-disc pl-5 marker:text-slate-500 text-justify md:text-left leading-relaxed">
                  <li><strong className="text-slate-200">Bimbingan Teknis:</strong> Membantu mahasiswa memahami konsep Array, Linked List, dan Tree dalam bahasa pemrograman Java.</li>
                  <li><strong className="text-slate-200">Evaluasi Logika:</strong> Meninjau dan memberikan masukan teknis terhadap tugas logika algoritma milik mahasiswa.</li>
                </ul>
              </div>
            </div>
      ...
      {/* --- KONTAK SECTION --- */}
      <section id="kontak" className="py-16 md:py-24 px-6 bg-[#0f172a] border-y border-slate-800/50">
        <div className="max-w-3xl mx-auto text-center reveal">
          <div className="text-emerald-500 font-mono text-sm mb-2">05. What's Next?</div>
          <h2 className="text-4xl md:text-5xl font-bold text-slate-100 mb-6">Mari Terhubung</h2>
...
<form onSubmit={handleFormSubmit} className="max-w-md mx-auto mb-12 text-left bg-[#0b1121] p-6 rounded-2xl border border-slate-800 shadow-xl relative">
          ...
          <div className="flex justify-center gap-4 md:gap-6 flex-wrap">
            ...
            <a href="https://github.com/Zackynashru" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-slate-900 border border-slate-700 text-white rounded-2xl flex items-center justify-center hover:-translate-y-2 transition-all shadow-lg">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path fillRule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z"/></svg>
            </a>
          </div>
      ...
      {/* Footer */}
      <footer className="py-8 text-center bg-[#0b1121] border-t border-slate-800/50 relative overflow-hidden">
